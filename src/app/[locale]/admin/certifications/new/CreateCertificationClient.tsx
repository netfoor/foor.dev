...
type CreateCertificationInput = {
  ...
  photoKey?: string;
  skills?: string[];
  category?: "Technology" | "Business" | "Arts" | "Health" | "Languages" | null;
  slug?: string;
};

const CreateCertificationClient: React.FC = () => {
  ...
  const handleInputChange = useCallback((field: keyof CreateCertificationInput, value: any) => {
    setFormData(prev => {
  ...
  // Manejar selección de imagen de certificado
  const handleCertificateImageSelect = useCallback((file: File) => {
    ...
    reader.onload = (e) => {
      setCertificateImagePreview(e.target?.result as string);
    };
    reader.readAsDataURL(file);
  }, [t]);

  // Remover imagen de certificado
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(`${t('certifications.error_creating_certification')}: ${err instanceof Error ? err.message : t('certifications.unknown_error')}`);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <View style={cssVariables}>
      <style dangerouslySetInnerHTML={{ __html: `
        .create-certification-form .amplify-field {
          margin-bottom: 1rem;
        }
        
        .create-certification-form .amplify-field > label {
        ...
        .create-certification-form .amplify-input,
        .create-certification-form .amplify-textarea,
        .create-certification-form .amplify-select select {
        ...
        .create-certification-form .amplify-input::placeholder,
        .create-certification-form .amplify-textarea::placeholder {
          color: var(--form-placeholder-color) !important;
          opacity: 0.8 !important;
          font-weight: 400 !important;
        }
        
        .create-certification-form .amplify-input:focus,
        .create-certification-form .amplify-textarea:focus,
        .create-certification-form .amplify-select select:focus {
          border-color: var(--form-focus-border) !important;
          box-shadow: 0 0 0 2px var(--form-focus-shadow) !important;
          outline: none !important;
        }
        
        .create-certification-form .amplify-field-group__control .amplify-field__description {
      ...
      <Flex direction="column" gap="1rem" marginBottom="2rem">
        <Flex alignItems="center" gap="1rem">
          ...
          <Heading level={1} style={{
            ...
            {t('certifications.create_certification')}
          </Heading>
        </Flex>
      </Flex>
      ...
      {/* Formulario */}
      <form onSubmit={handleSubmit} className="create-certification-form">
          ...
          <Card style={{
            ...
            <View padding="1.5rem">
              ...
              {certificateImagePreview ? (
                ...
                <FileUploadInput
                  onFileSelect={handleCertificateImageSelect}
                  accept="image/*"
                >
                  <Card
                    style={{
                  ...
                  >
                    <View padding="2rem" textAlign="center">
                      ...
                      <Text style={{
                        ...
                        {t('certifications.certificate_upload_text')}
                      </Text>
                      <Text style={{
        ...
        >
          ...
          <Button
            ...
            variation="primary"
            isLoading={loading}
            loadingText={t('certifications.creating')}
            style={{
...
export default CreateCertificationClient;
